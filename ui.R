             ...
             tabPanel("MEGA-RVs",
                      ...
                      sidebarLayout(
                        sidebarPanel(
                                 ...
                                 selectInput("stat.test", 'Statistical Test', choices=c("GLM (Negative Binomial)"=1,"Wilcoxon"=2), selected=2),
                                 ...
                                 radioButtons("genome","Genome for Monte Carlo Simulation",choices=c("HG19","HG38"),selected="HG19"),
